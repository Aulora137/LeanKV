#!/bin/bash
# Phase 2b: Cross-architecture perplexity benchmark (Gemma 3 4B + Llama 3.2 3B)
set -euo pipefail
...
CSV_FILE="${RESULTS_DIR}/ppl_benchmark_cross_arch.csv"
LOG_DIR="${RESULTS_DIR}/logs"

mkdir -p "$RESULTS_DIR" "$LOG_DIR"

declare -A MODELS
MODELS["Gemma3-4B"]="/home/junc/Aulora/bitcoin-node-stack/models/gemma-3-4b-it-Q4_K_M.gguf"
MODELS["Llama3.2-3B"]="/home/junc/Aulora/bitcoin-node-stack/models/Llama-3.2-3B-Instruct-Q4_K_M.gguf"
...
MODEL_ORDER=("Gemma3-4B" "Llama3.2-3B")
